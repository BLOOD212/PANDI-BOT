...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  if (command === "play") {
    ...
    if (!text) return m.reply("🤖 *pandi-bot* • 🎧 Scrivi il titolo di una canzone!")
...
*Vuoi l'audio o il video?*`,
  ...
  if (command === "play_audio") {
    ...
    let infoMsg = `🎧 *pandi-bot* • Scarico l'audio di:\n_${video.title}_`
  ...
  if (command === "play_video") {
    ...
    await m.reply("🎥 *pandi-bot* • Elaborazione e download del video in corso...")
