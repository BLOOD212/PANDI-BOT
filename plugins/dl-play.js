  ...
  try {
    ...
    if (isAudio) {
        ...
        await conn.sendMessage(m.chat, {
            ...
            mimetype: 'video/mp4',
            caption: `✅ *𝐒𝐜𝐚𝐫𝐢𝐜𝐚𝐭𝐨 𝐝𝐚 𝐏𝐚𝐧𝐝𝐢-𝐁𝐨𝐭*`,
        }, { quoted: m });
    }
    ...
    console.error(e);
    m.reply('🚀 *𝐏𝐚𝐧𝐝𝐢-𝐁𝐨𝐭 𝐄𝐑𝐑𝐎𝐑:* File non disponibile o server offline.');
  }
};
